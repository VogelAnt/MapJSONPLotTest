...
//    property int markerCount: 0
//    property int currentIndex: -1
//    property bool singleScenarioSelected: false
//    property bool drawScenarioSelected: false
//    property string brd_clr: "#f5f5f5"
//    Connections{
//        target: markerModel
//            onComboBoxSelectionChanged:{
...
//                console.log("RECEIVED CHANGE SIGNAL FROM C++ IN QML")
//                polygonmodel.clear()
//                console.log("Model clear function was called")
//                markerCount = markerModel.resetMarkerCount()
//                singleScenarioSelected = markerModel.getSingleScenarioStatus()
//                drawScenarioSelected = markerModel.getDrawScenarioStatus()
//                changeBorderColor()
//                }
//            onRemoveMarkerFromUI:{
//                console.log("RECEIVED CHANGE SIGNAL FROM C++ IN QML "+marker_idx)
//            }
//    }
...
//        gesture.enabled: currentIndex == -1
//        center: QtPositioning.coordinate(35.646971, 139.718614)
//        zoomLevel: 14
//        MapItemView{
//            z: polygon.z + 1
//            model: polygonmodel
